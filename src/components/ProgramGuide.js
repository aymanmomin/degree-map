...
const sampleCourses = {
  ...
  "Year 2": [
    ...
    { code: "PHIL 314", title: "nformation Technology Ethics" },
  ],
  "Year 3": [
...
export default function ProgramGuide({ courses = sampleCourses }) {
  ...
  const handleAddToCurrentSemester = () => {
    console.log(`Added ${selectedCourse.code} to current semester`);
    setModalShow(false);
  };

  const handleAddToNextSemester = () => {
    console.log(`Added ${selectedCourse.code} to next semester`);
    setModalShow(false);
  };

  const handleAddToWaitlist = () => {
    console.log(`Added ${selectedCourse.code} to waitlist`);
    setModalShow(false);
  };
    ...
    <div className="py-5 bg-light">
      <div className="container">
        ...
        <Modal
          ...
          addToCurrentSemester={handleAddToCurrentSemester}
          addToNextSemester={handleAddToNextSemester}
          addToWaitlist={handleAddToWaitlist}
        />
      </div>
    </div>
  );
