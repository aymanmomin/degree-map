...
export default function Courses() {
  ...
  const filteredCourses = courses.filter((course) => {
    ...
    if (subjectCode !== "CPSC" && !course.CourseCode.startsWith(subjectCode)) return false;
    if (courseLevel && course.CourseCode.split(' ')[1] !== courseLevel) return false;
    return true;
  });
          ...
          <div className="col-md-10">
            ...
            <div className="list-group">
              ...
              {filteredCourses.map((course) => (
                <div key={course.CourseCode} className="list-group-item">
                  <h4 className="list-group-item-heading">
                    {course.CourseCode}
                    <span className="btn btn-light">{course.CourseCode}</span>
                  </h4>
                  <p className="list-group-item-text">
                    {course.Description}
                    <br />
                    <br />
                    <span className="">3 Units</span>
                  </p>
                </div>
              ))}
